...
mydata$M_spwgrd_surv <- M_spwgrd_surv
...
#on spawning ground
mydata$M_spwn_grd <- mydata$M_regions#*M_spwgrd_mult
mydata$M_spwn_grd[1:(age_mat-min(ages)+1-1),,] <- 0 #for fish unmature fish => no mortality on spw ground
