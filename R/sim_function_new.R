...
#Script: population dynamics simulation 

# Juliette Champagnat
#################################################
 

"life_cycle_sim" <- function(data,traj= 10,param_R="h",age.plus=FALSE){
  ...
  # create Process Error vectors
  # not used in the Microproject
